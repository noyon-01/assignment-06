## Project Name is : Digital Tools Buying Website.

## A little Description is below here:
...
## 3 Features about my project is:
- Toggle System: Users can easily switch between Product and Cart sections using two buttons.
- Cart Management: Users can add products, remove items, and see selected products with name and price.
- Checkout Functionality: Users can view total price and clear all cart items using the “Proceed to Checkout” button.
